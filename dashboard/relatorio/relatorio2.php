...
$data = mysqli_query($conexao, "select * from tb_igreja WHERE ativo = '0';") or die(mysqli_error("ERRO: ".$conexao));
...
$html  = "<table class='table table-striped' width='100%'  cellspacing='0' cellpading='0'>";
                ...
                $html .= "<td width='70,00%' align='center'><strong><h1 align='center'>Igrejas com Cadastro Inativo</h1></strong></td>";       
				$html .= "</tr></thead><tbody>";
                $html .=  "</tr>";
				$html .= "</tbody></table>";
