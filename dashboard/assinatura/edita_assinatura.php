...
<div id="main" class="container-fluid">
	...
	<div class="row"> 
        ...
        <?php
                    $data2 = mysqli_query($conexao, "select * from tb_membro WHERE voluntario = '1' AND cod_igreja = '".$_SESSION['cod_igreja']."';") or die(mysqli_error("ERRO: ".$conexao)); ?>
                    <div class="form-group col-md-2" name="id_membro[]">
                    <label for="cod_curso">Voluntário</label>
                    <select class="form-control" name="id_membro[]">
                    <option name="id_membro[]" value="<?php echo $info['id_membro']; ?>"><?php echo $info['nome_membro']; ?></option>
