<?php
    ...
    $id_usuario = rand(5, 15);

    $sql = "insert into tb_membro (id_usuario, foto, cod_igreja, nome_membro, funcao_membro, dt_nascimento, sexo, rg, cpf, email, telefone, cep, estado, cidade, endereco, bairro, complemento, perfil, status)values ";
    $sql .= "('$id_usuario','$novoNome2','$cod_igreja','$nome_membro','$funcao_membro','$fdg_dt_nasc','$sexo','$rg','$cpf','$email','$telefone','$cep','$estado','$cidade','$endereco','$bairro','$complemento','$perfil','$status')";
