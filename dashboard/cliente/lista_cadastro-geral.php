...
<div id="main" class="container-fluid">
	<div id="top" class="row">
		...
		<div class="col-md-2">
			<!-- Chama o Formulário para adicionar membros -->
	...
	<div id="list" class="row">
		<div class="table-responsive col-md-12">
			<?php
				$data = mysqli_query($conexao, "select * from tb_membro WHERE cod_igreja = '".$cod_igreja."' order by id_usuario") or die(mysqli_error("ERRO: ".$conexao));
				...
				while($info = mysqli_fetch_array($data)){ 
					...
					echo "<a class='btn btn-success btn-xs' href=?page=cad_voluntario&id_membro=".$info['id_membro']." > Habilitar Como Voluntário </a>";
					echo "<a class='btn btn-info btn-xs' href=?page=view_cadastro-geral&id_membro=".$info['id_membro']." > Detalhes </a>";
