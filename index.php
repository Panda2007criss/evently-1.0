...
<body>
    ...
    <section class="bg-gray-50 dark:bg-gray-800" id="beneficios">
        <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            ...
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                ...
                <img class="w-full mb-4 rounded-lg lg:mb-0 lg:flex" src="./images/3885914.jpg" alt="dashboard feature image">
            </div>
            <!-- Row -->
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <img class="w-full mb-4 rounded-lg lg:mb-0 lg:flex" src="images/calendar-schedule-list.jpg" alt="feature image 2">
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
    ...
    <section class="bg-gray-50 dark:bg-gray-800" id="teste-gratis">
        <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
            <div class="max-w-screen-sm mx-auto text-center">
                <h2 class="mb-4 text-3xl font-extrabold leading-tight tracking-tight text-gray-900 dark:text-white">Teste Grátis por 7 dias.</h2>
                <p class="mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">Não precisa cadastrar cartão, utilize a plataforma gratuitamente por 7 dias.</p>
                <a href="dashboard/cadastro-cliente.php" class="text-white bg-purple-700 hover:bg-purple-200 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:text-white  dark:focus:ring-purple-900">QUERO TESTAR POR 7 DIAS</a>
            </div>
        </div>
    </section>
    <!-- End block -->
